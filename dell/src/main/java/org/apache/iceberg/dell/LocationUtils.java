...
public class LocationUtils {
  ...
  public static String removeLastDelimiter(String name, String delimiter) {
  ...
  public static String addLastDelimiterForPrefix(String name, String delimiter) {
    if (name.isEmpty() || name.endsWith(delimiter)) {
      return name;
    }
